...
LOOPS = 10      # Сколько раз ИИ может вызывать повторно инструменты при нужде          |   По стандарту 10, но можете уменьшить, если ИИ много думает напрасно
...
os.makedirs('./AI files', exist_ok=True)    # AI files
os.makedirs('./Logs', exist_ok=True)        # Logs
os.makedirs('./Mods', exist_ok=True)        # Mods
os.makedirs('./Settings', exist_ok=True)    # Settings
