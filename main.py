...
while True:
    try:
        ...
        while tool_check and (step_tool < LOOPS): # Цикл с использованием инструментов
            ...
            response = ollama.chat(model=MODEL, messages=history, options={'num_thread': CPU, 'num_predict': CW, 'repeat_penalty': 1.0}, tools=used_tools)
